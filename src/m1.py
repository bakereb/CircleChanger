...
class CircleChanger(object):
    ...
    def swallow(self, other_circle_changer):
        ...
        a = self.circle.center.halfway_to(other_circle_changer.circle.center)
        b = self.circle.center.get_distance_from(other_circle_changer.circle.center)
        return CircleChanger(a.x, a.y, b / 2, 'red', self.colors + other_circle_changer.colors)
